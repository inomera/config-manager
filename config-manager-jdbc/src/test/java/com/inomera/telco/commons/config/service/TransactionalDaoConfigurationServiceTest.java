...
class TransactionalDaoConfigurationServiceTest {
    ...
    private TransactionalDaoConfigurationService service;

    @BeforeEach
    void init() {
        this.service = new TransactionalDaoConfigurationService(transactionTemplate, lockProvider, configurationDao, MAX_LENGTH);
