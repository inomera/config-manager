 ...
 */
public class TransactionalDaoConfigurationService implements ConfigurationUpdateService, ConfigurationFetcherService {
    private static final Logger LOG = LoggerFactory.getLogger(TransactionalDaoConfigurationService.class);
     ...
     */
    public TransactionalDaoConfigurationService(TransactionTemplate transactionTemplate, LockProvider lockProvider, ConfigurationDao configurationDao, int concatConfigurationMaxLength) {
