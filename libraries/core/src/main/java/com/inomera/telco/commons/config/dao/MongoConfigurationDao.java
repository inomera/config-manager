...
public class MongoConfigurationDao implements ConfigurationDao {
    ...
    public MongoConfigurationDao(MongoClient mongoClient, String dbName, String collectionName, String keyFieldName,
                                 String valueFieldName, Document query) {
    ...
    public Map<String, String> findAllConfigurations() {
        final FindIterable<Document> documents = mongoClient.getDatabase(dbName)
                .getCollection(collectionName)
                .find(query)
                .projection(include(keyFieldName, valueFieldName));
