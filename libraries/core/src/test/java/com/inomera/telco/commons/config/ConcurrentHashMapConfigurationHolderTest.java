...
class ConcurrentHashMapConfigurationHolderTest {
    ...
    void initialize() {
        ...
        Mockito.when(configurationFetcherService.fetchConfiguration()).thenReturn(configurationsMap);
    ...
    void getStringProperty_defaultFallback() {
        ...
        Assertions.assertNotNull(value);
        Assertions.assertEquals("defaultValue1", value);
    }
    ...
    void getConcatStringProperty_shouldReturnConcatenatedString() {
        ...
        Assertions.assertEquals("internationalization", value);
    }
    ...
    void getLongProperty_success() {
        ...
        Assertions.assertNotNull(value);
        Assertions.assertEquals(2345L, value.longValue());
    }
    ...
    void getLongProperty_defaultSuccess() {
        ...
        Assertions.assertEquals(2345L, value);
    }
    ...
    void getIntegerProperty_success() {
        ...
        Assertions.assertNotNull(value);
        Assertions.assertEquals(new Integer(123), value);
    }
    ...
    void getJsonObjectProperty_shouldReturnInstanceOfGivenClassWhenValidJsonProvided() {
        ...
        Assertions.assertNotNull(value);
        Assertions.assertEquals("Inomera", value.getName());
    }
    ...
    void getJsonObjectProperty_shouldReturnDefaultValueWhenPropertyNotExist() {
        ...
        Assertions.assertNotNull(value);
        Assertions.assertSame(defaultValue, value);
        Assertions.assertEquals("Test", value.getName());
    }
    ...
    void getJsonObjectProperty_shouldReturnDefaultValueWhenInvalidJsonObjectInMap() {
        ...
        Assertions.assertNotNull(value);
        Assertions.assertSame(defaultValue, value);
        Assertions.assertEquals("Test1", value.getName());
    }
    ...
    void getJsonObjectProperty_shouldReturnInstanceOfGivenClassWhenValidJsonProvidedAndDefaultIsProvided() {
        ...
        Assertions.assertNotNull(value);
        Assertions.assertEquals("Inomera", value.getName());
        Assertions.assertNotSame(defaultValue, value);
    }
    ...
    void getJsonObjectProperty_shouldReturnDefaultValueWhenPropertyValueIsNullString() {
        ...
        Assertions.assertSame(value, defaultValue);
    }
    ...
    void getJsonListProperty_shouldReturnInstanceOfGivenClassWhenValidJsonProvided() {
        ...
        Assertions.assertEquals("Inomera", value.get(0).getName());
    }
    ...
    void getJsonListProperty_shouldReturnDefaultValueWhenPropertyNotExist() {
        ...
        Assertions.assertSame(defaultValue, value);
        Assertions.assertEquals(1, value.size());
        Assertions.assertEquals("Test", value.get(0).getName());
    }
    ...
    void getJavaProperties_shouldGetJavaProperties() {
        ...
        Assertions.assertEquals("valueOne", properties.getProperty("propertyOne"));
        Assertions.assertEquals("valueTwo", properties.getProperty("propertyTwo"));
    }
    ...
    void addOnChangeListener() {
        ...
        Assertions.assertSame(listener, removedListener);
    }
    ...
    void removeNonExistentListenerForConfigurations() {
        ...
        final ConfigurationChangeListener removedListener = configurationHolder.removeOnChangeListener(listenerId);
        Assertions.assertNull(removedListener);
    }
    ...
    void removeOnChangeListenerInDifferentOrder() {
        ...
        Assertions.assertSame(listener1, removedListener1);
        Assertions.assertSame(listener2, removedListener2);
        Assertions.assertSame(listener3, removedListener3);
    }
    ...
    void reloadConfigurations_shouldChangeDetection() {
        ...
        configurationHolder.addOnChangeListener("stringProp", (configKey, oldValue, newValue) -> {
            Assertions.assertEquals("test1", newValue);
            Assertions.assertEquals("test", oldValue);
            Assertions.assertEquals("stringProp", configKey);
            isListenerCalled.set(true);
        });

        Mockito.when(configurationFetcherService.fetchConfiguration()).thenReturn(configurationsMap);
        configurationHolder.reloadConfigurations();
        Assertions.assertTrue(isListenerCalled.get());
    }
    ...
    void reloadConfigurations_shouldLoadFromService() {
        ...
        Mockito.when(configurationFetcherService.fetchConfiguration())
                .thenReturn(previousMap)
                .thenReturn(nextMap);

        configurationHolder.reloadConfigurations();

        Assertions.assertEquals(1, configurationHolder.getIntegerProperty("a", 1453));
        Assertions.assertEquals(2, configurationHolder.getIntegerProperty("b", 1453));
        Assertions.assertEquals(3, configurationHolder.getIntegerProperty("c", 1453));
        Assertions.assertEquals(1453, configurationHolder.getIntegerProperty("d", 1453));

        configurationHolder.reloadConfigurations();

        Assertions.assertEquals(5, configurationHolder.getIntegerProperty("a", 1453));
        Assertions.assertEquals(6, configurationHolder.getIntegerProperty("b", 1453));
        Assertions.assertEquals(1453, configurationHolder.getIntegerProperty("c", 1453));
        Assertions.assertEquals(9, configurationHolder.getIntegerProperty("d", 1453));
    }
