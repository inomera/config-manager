...
import com.inomera.telco.commons.config.service.TransactionalDaoConfigurationService;
...
public class ConfigManagerJdbcAutoConfiguration {
    ...
    public static class JdbcConfigurationSourceConfiguration {
        ...
        public ConfigurationFetcherService configurationFetcherService(
            ...
            return new TransactionalDaoConfigurationService(transactionTemplate, lockProvider, configurationDao, concatConfigurationMaxLength);
        }
    }
}
